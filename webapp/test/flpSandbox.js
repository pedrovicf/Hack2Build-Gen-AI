					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hack2Build Gen Ai",
									"targetURL": "#hack2build-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"hack2build-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hack2build",
									"url": sap.ui.require.toUrl("hack2build")
								}
							}
						}
					}
